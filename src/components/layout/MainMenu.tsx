        ...
        <div className="relative" ref={ref}>
            ...
            {open && (
                ...
                <div
                    className={`
            z-50 
            fixed left-1/2 top-[140px] w-[90vw] -translate-x-1/2
            lg:absolute lg:top-[90px] lg:w-[500px] lg:translate-x-[-400px]
        `}
                >
                    {/* contenido */}
                    <div
                        ...
                        className="flex max-h-[72vh] w-full flex-col overflow-hidden rounded-xl bg-white shadow-lift ring-1 ring-gold-300/70"
                    >
